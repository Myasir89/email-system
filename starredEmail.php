...
include('support/starred_action.php');
?>
            ...
            <div class="main-content" style="background-color: #303641" > 
                ...
                <div class="mail-env" style="background-color: white"> 
                    ...
                    <div class="mail-body"> <div class="mail-header"> 
                        ...
                        <h3 class="mail-title">Starred </h3> 
                                ...
                                <tr>
                                    ...
                                    <td class="col-name">                                         
                                        ...
                                        <a <?php if($status == 'sent' || $status == 'inbox'){ ?>
                                                href="message.php?id=<?php echo $email_id; ?>&action=<?php if($status == 'inbox'){ echo 'receiveEmail'; }else if($status == 'sent'){ echo 'sentEmail'; }?>" 
                                            <?php }else if($status == 'draft'){ ?> 
                                                href="compose_draft.php?id=<?php echo $email_id; ?>&status=<?php echo 'draft'?>" 
                                            <?php } ?>
