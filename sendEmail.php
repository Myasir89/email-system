...
include('support/sent_action.php');
?>
                        ...
                        <tbody> 
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="col-subject"> <a href="message.php?id=<?php echo $id; ?>&action=<?php echo 'sentEmail'; ?>"><?php echo $emailSubject; ?></a> </td> 
